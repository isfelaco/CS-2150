...
start:
	push r8
	xor r8, r8
	cmp rsi, rdx		; does start == end?
	jge done			; if so, jump to end

	mov r8, rdx			; mid = (rdx + rsi) / 2
	add r8, rsi
	shr r8, 1			
	...
	mov rdx, r8			; move mid to "right"

	call mergeSort		; mergeSort from start to mid
	pop rcx
	pop rdx
	pop rsi
	pop r8
	...
	inc r8				; mid = mid + 1
	mov rsi, r8			; move mid + 1 to "left"

	call mergeSort		; mergeSort from mid + 1 to end
	...
	mov rcx, rdx		; move "right" to new "right"
	mov rdx, r8			; move mid for merge param 3
