 ...
 * This function...
 * 
 * @param first Vector of strings
 * @param last Vector of strings
 * @param g Randomly generated number
 */
 ...
 * 
 * This function creates a MiddleEarth object.
 * 
 * @param xsize Horizontal size of map
 * @param ysize Vertical size of map
 * @param num_cities Number of cities to include
 * @param seed Seed to use random number generator
 * 
 */
...
/**
 * @brief Prints out info on the create 'world'.
 * 
 * This function Prints out the number of cities to choose from, then the cities being used.
 */
 ...
 * 
 * This function prints a tab-separated table of the distances, which can be loaded into Excel or similar.
 */
 ...
 * 
 * This method retrieves the distance between two passed cities from the table of distances.
 * 
 * @return The distance between the two passed cities
 * @param city1 Address of the first city in memory
 * @param city2 Address of the second city in memory
...
/**
 * @brief Retrieves a number of cities based on length
 * 
 * This method takes in length and creates an itinerary of cities based on that number.
 * 
 * @return itinerary The list of cities to travel to
 * @param length 
 * @note The first city is the original start point as well as the end point.
